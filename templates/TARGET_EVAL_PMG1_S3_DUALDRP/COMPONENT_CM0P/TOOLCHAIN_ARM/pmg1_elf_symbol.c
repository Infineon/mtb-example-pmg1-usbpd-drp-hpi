...
(
    ...
    ".equ __cy_app_verify_length,    " CY_STR(CY_APP0_FLASH_LENGTH) "\n"
#else
    ".equ __cy_app_verify_start,     " CY_STR(CY_APP1_FLASH_ADDR) "\n"
    ".equ __cy_app_verify_length,    " CY_STR(CY_APP1_FLASH_LENGTH) "\n"
#endif /* (CY_APP_TYPE ==0) */
#endif /* (CY_APP_FIRMWARE_ARCH == 0) */
...
#else
#if (CY_APP_TYPE == 0)
    ".equ __cy_memory_0_start,    " CY_STR(CY_APP0_FLASH_ADDR) "\n"
    ".equ __cy_memory_0_length,   " CY_STR(CY_APP0_FLASH_LENGTH) "\n"
    ".equ __cy_memory_0_row_size, 0x100 \n"

    ".equ __cy_memory_1_start,    " CY_STR(CY_BOOT_META0_FLASH_ADDR) "\n"
    ".equ __cy_memory_1_length,   " CY_STR(CY_BOOT_META0_FLASH_LENGTH) "\n"
    ".equ __cy_memory_1_row_size, 0x100 \n"
#else
    ".equ __cy_memory_0_start,    " CY_STR(CY_APP1_FLASH_ADDR) "\n"
    ".equ __cy_memory_0_length,   " CY_STR(CY_APP1_FLASH_LENGTH) "\n"
    ".equ __cy_memory_0_row_size, 0x100 \n"

    ".equ __cy_memory_1_start,    " CY_STR(CY_BOOT_META1_FLASH_ADDR) "\n"
    ".equ __cy_memory_1_length,   " CY_STR(CY_BOOT_META1_FLASH_LENGTH) "\n"
    ".equ __cy_memory_1_row_size, 0x100 \n"
#endif /* (CY_APP_TYPE == 0) */
#endif /* (CY_APP_FIRMWARE_ARCH ==0) */
